...
function Features() {
  return (
    <section className="bg-primary-1500 overflow-hidden bg-[url('../src/assets/Noise.webp')]bg-repeat">
        ...
        <div className="bg-primary-1300 absolute top-[50%] left-[100%] h-[62.5rem] w-[62.5rem] -translate-x-[50%] -translate-y-[50%] rounded-full opacity-30 blur-[20rem]" />
        ...
        <div className="mb-20 grid grid-cols-2 items-center gap-x-16">
            ...
            <div className="z-1 max-w-lg justify-self-end">
                <p className="mb-8 text-5xl/16 font-semibold tracking-tighter">Smart Organizartion</p>
