...
function Features() {
  return (
    <section className="bg-primary-1500 overflow-hidden bg-[url('../src/assets/Noise.webp')]bg-repeat">
        ...
        <div className="bg-primary-1300 absolute top-[50%] left-[100%] h-[62.5rem] w-[62.5rem] -translate-x-[50%] -translate-y-[50%] rounded-full opacity-30 blur-[20rem] max-xl:h-[35rem] max-xl:w-[35rem] max-xl:blur-[10rem]" />
        ...
        <div className="mb-20 grid grid-cols-2 items-center gap-x-16 max-xl:mb-12">
            ...
            <div className="z-1 max-w-lg justify-self-end">
                <p className="mb-8 text-5xl/16 font-semibold tracking-tighter max-xl:mb-6 max-xl:text-4xl/10">Smart Organizartion</p>
                <p className="text-primary-100 z-1 text-xl/loose font-light max-xl:text-lg/8"> Automatically categorize and tag your notes using AI-driven analysis. NoteFlow intelligently identifies key topics and organizes your content, making it easy to find and retrieve your notes when you need them most.</p>
            </div>
        </div>
