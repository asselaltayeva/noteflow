...
function Navigation() {
  ...
  return (
    <nav className="text-primary-50 m-auto flex items-center justify-between max-w-[90rem] px-24 text-lg/8 font-light max-xl:px-16 max-xl:text-base/loose max-lg:px-8">
      <a href="#" className="flex items-center gap-x-3">
        <Logo className="h-6" width={5} />
        <p className="text-xl font-bold tracking-tight">NoteFlow</p>
      </a>

      <ul className="flex items-center gap-x-10 font-medium max-xl:gap-x-6 max-lg:hidden">
