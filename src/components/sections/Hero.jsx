...
function Hero() {
  ...
  return (
    ...
    <div > 
        <h1 className="text-primary-50 mb-6 text-6xl/18 font-semibold tracking-tighter max-xl:mb-4 max-xl:text-5xl/16"> AI-Powered Notes. Organize & Summarize in Seconds</h1>
        <p className="text-primary-100 mb-10 text-xl/loose font-light max-xl:mb-8 max-xl:text-lg/8"> Let AI organize & summarize your notes, <br/>
